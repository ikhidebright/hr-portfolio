<template>
<div>
    <p class="headT ml-4 mb-n7 mt-n3">View Company details ({{ details.name }})</p>
    <v-row>
    <v-col
    cols="12"
    lg="10"
...
export default {
    ...
    mounted () {
        this.details = this.$store.getters['company/getCompanyDetailsById'](this.$route.params.id)
