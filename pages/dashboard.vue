    ...
    <v-row class="ma-0">
      <v-col cols="12" sm="6" md="8">
        <v-row class="ma-0 ml-0 mt-n7">
          <v-col
            v-for="(company, i) in dashboardPrices"
            :key="i"
            cols="4"
            class="pa-0"
          >
        ...
        <v-row class="ma-0">
          <v-card class="rounded-lg mt-4 ml-0" flat width="1050">
            <v-card-text>
              <p class="font-weight-bold">Increase Per Month</p>
              <client-only>
                <vue-highcharts
                  :options="increasePerMonth"
                  ref="lineCharts"
                ></vue-highcharts>
              </client-only>
            </v-card-text>
      ...
      <v-col cols="6" md="4">
        <!-- revenue graph -->
        <v-card class="rounded-lg mt-n8 ml-1" flat width="900">
          <v-card-text>
